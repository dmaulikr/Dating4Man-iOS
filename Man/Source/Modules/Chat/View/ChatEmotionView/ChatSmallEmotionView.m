...
@interface ChatSmallEmotionView()<UIScrollViewDelegate>
/** 当前页数 */
@property (nonatomic,assign) NSInteger curIndex;

@end

@implementation ChatSmallEmotionView

+ (instancetype)chatSmallEmotionView:(id)owner {
    NSArray *nibs = [[NSBundle mainBundle] loadNibNamedWithFamily:@"ChatSmallEmotionView" owner:owner options:nil];
    ChatSmallEmotionView* view = [nibs objectAtIndex:0];
    
    UINib *nib = [UINib nibWithNibName:@"ChatSmallEmotionCollectionViewCell" bundle:nil];
    [view.emotionCollectionView registerNib:nib forCellWithReuseIdentifier:[ChatSmallEmotionCollectionViewCell cellIdentifier]];
