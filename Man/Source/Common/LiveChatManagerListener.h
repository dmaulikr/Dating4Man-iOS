 ...
 */
- (void)onGetUserStatus:(LCC_ERR_TYPE)errType errMsg:(NSString* _Nonnull)errMsg users:(NSArray* _Nonnull)users;
 ...
 */
- (void)onGetUsersInfo:(LCC_ERR_TYPE)errType errMsg:(NSString* _Nonnull)errMsg usersInfo:(NSArray* _Nonnull)usersInfo;
