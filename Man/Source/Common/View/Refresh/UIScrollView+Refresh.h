 ...
 *  设置尾部控件的文字
 */
@property (nonatomic,copy) NSString *footerPullToRefreshText; // 默认:@"上拉可以加载更多数据"
@property (nonatomic,copy) NSString *footerReleaseToRefreshText; // 默认:@"松开立即加载更多数据"
@property (nonatomic,copy) NSString *footerRefreshingText; // 默认:@"正在帮你加载数据..."


/**
 *  设置头部控件的文字
 */
@property (nonatomic,copy) NSString *headerPullToRefreshText; // 默认:@"下拉可以刷新"
@property (nonatomic,copy) NSString *headerReleaseToRefreshText; // 默认:@"松开立即刷新"
@property (nonatomic,copy) NSString *headerRefreshingText; // 默认:@"正在帮你刷新..."
@end
