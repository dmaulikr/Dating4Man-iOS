...
#pragma mark - 运行时相关
static char RefreshHeaderViewViewKey;
static char RefreshFooterViewViewKey;

- (void)setHeader:(RefreshHeaderView *)header {
    [self willChangeValueForKey:@"RefreshHeaderViewViewKey"];
    objc_setAssociatedObject(self, &RefreshHeaderViewViewKey,
                             header,
                             OBJC_ASSOCIATION_ASSIGN);
    [self didChangeValueForKey:@"RefreshHeaderViewViewKey"];
}

- (RefreshHeaderView *)header {
    return objc_getAssociatedObject(self, &RefreshHeaderViewViewKey);
}

- (void)setFooter:(RefreshFooterView *)footer {
    [self willChangeValueForKey:@"RefreshFooterViewViewKey"];
    objc_setAssociatedObject(self, &RefreshFooterViewViewKey,
                             footer,
                             OBJC_ASSOCIATION_ASSIGN);
    [self didChangeValueForKey:@"RefreshFooterViewViewKey"];
}

- (RefreshFooterView *)footer {
    return objc_getAssociatedObject(self, &RefreshFooterViewViewKey);
}
